...
/* prepare_protocol.h - the protocol for preparing values for DBSQL
 *
...
#ifndef PYDBSQL_PREPARE_PROTOCOL_H
#define PYDBSQL_PREPARE_PROTOCOL_H
#include "Python.h"

typedef struct
{
    PyObject_HEAD
} pydbsql_PrepareProtocol;

extern PyTypeObject pydbsql_PrepareProtocolType;
...
int pydbsql_prepare_protocol_setup_types(void);
